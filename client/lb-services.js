      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Users/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Access-Token.user() instead.
            "::get::Access-Token::user": {
              url: urlBase + "/Access-Tokens/:id/user",
              method: "GET",
            },
...
/**
 * @ngdoc object
 * @name lbServices.Access-Token
 * @header lbServices.Access-Token
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Access-Token` model.
 *
 * ## Example
 *
 * See
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Access-Tokens/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#create
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Access-Token` object.)
             * </em>
             */
            "create": {
              url: urlBase + "/Access-Tokens",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#createMany
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#patchOrCreate
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#replaceOrCreate
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/Access-Tokens/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#upsertWithWhere
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/Access-Tokens/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#exists
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/Access-Tokens/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#findById
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "findById": {
              url: urlBase + "/Access-Tokens/:id",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#replaceById
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/Access-Tokens/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#find
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#findOne
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/Access-Tokens/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#updateAll
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/Access-Tokens/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#deleteById
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#count
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/Access-Tokens/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Access-Token#prototype$patchAttributes
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#createChangeStream
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/Access-Tokens/change-stream",
              method: "POST",
            },
          }
        );
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#upsert
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
        ...
        R["upsert"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#updateOrCreate
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#patchOrCreateWithWhere
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
        ...
        R["patchOrCreateWithWhere"] = R["upsertWithWhere"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#update
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#destroyById
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#removeById
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Access-Token#prototype$updateAttributes
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Access-Token#modelName
        * @propertyOf lbServices.Access-Token
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Access-Token`.
        */
        R.modelName = "Access-Token";


            /**
             * @ngdoc method
             * @name lbServices.Access-Token#user
             * @methodOf lbServices.Access-Token
             *
             * @description
             *
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::Access-Token::user"];
          return action.apply(R, arguments);
        };
