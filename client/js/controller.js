    ...
    .controller('FormCtrl', function ($scope, $http, AuthService) {
      if (AuthService.getCurrent()) {
        ...
        $scope.towns = [
          ...
          'Plano', 'Ponder', 'Prosper', 'Providence Village', 'Roanoke', 'Sanger', 'Shady Shores', 'Southlake', 'The Colony', 'Trophy Club',
          'Westlake', 'Copperas Cove', 'Evant', 'Gatesville', 'McGregor', 'Oglesby', 'South Mountain', 'Callisburg', 'Gainesville',
          'Lindsay', 'Muenster', 'Oak Ridge', 'Pilot Point', 'Valley View', 'Allen', 'Anna', 'Blue Ridge', 'Fiarview', 'Farmersville', 'Josephine',
          'Lavon', 'Lowry Crossing', 'Lucas', 'McKinney', 'Melissa', 'Murphy', 'Nevada', 'New Hope', 'Parker', 'Pronceton', 'Royse City', 'Sachse',
          'St. Paul', 'Trenton', 'Van Alstyne', 'Weston', 'Brownwood', 'Blanket', 'Bangs', 'Early', 'Bryan', 'College Station', 'Kurten', 'Millican',
          'Navasota', 'Wixon Valley', 'Heath', 'Fate', 'Rockwall', 'Mobile City', 'McLendon-Chisolm', 'Arlington', 'Azle', 'Beford', 'Benbrook', 'Blue Mound',
          ...
          'Roanoke', 'Saginaw', 'Sansom Park', 'Southlake', 'Trohpy Club', 'Watauga', 'Westlake', 'Westover Hills', 'Westworth Village', 'White Settlement', 'Abilene',
          'Buffalo Gap', 'Impact', 'Lawn', 'Merkel', 'Trent', 'Tuscola', 'Tye', 'Alma', 'Bardwell', 'Cedar Hill', 'Ennis', 'Ferris', 'Garrett', 'Glenn Heights', 'Italy',
